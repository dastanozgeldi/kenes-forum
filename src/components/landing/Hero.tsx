  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center">
          ...
          <span className="text-primary">
            <Typewriter
              options={{
                autoStart: true,
                loop: true,
                strings: ["meet", "share", "collaborate efficiently"],
              }}
            />
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
        <HeroCard href="#about" title="About Kenes">
          what is Kenes, its importance and purposes.
        </HeroCard>
        <HeroCard href="#features" title="Features">
          what Kenes offers, the benefits of using it and many more.
        </HeroCard>
      </div>
    </div>
  );
